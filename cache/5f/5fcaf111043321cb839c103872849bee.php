...
/* ./routes/partials/admin/administrador.html */
class __TwigTemplate_6dd14b0b8e02f5db945086999ae2292b extends Template
{
...
\t\t\t\t\t\t\t\t\t<img src=\"/assets/images/plantillas/Plantilla1.svg\" alt=\"Plantilla 1\" class=\"form-imagecheck-image\">
\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t</label>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"col-4\">
...
\t\t\t\t\t\t\t\t<span class=\"form-imagecheck-figure\">
\t\t\t\t\t\t\t\t\t<img src=\"/assets/images/plantillas/Plantilla2.svg\" alt=\"Plantilla 2\" class=\"form-imagecheck-image\">
\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t</label>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t<span class=\"form-imagecheck-figure\">
\t\t\t\t\t\t\t\t\t<img src=\"/assets/images/plantillas/Plantilla3.svg\" alt=\"Plantilla 3\" class=\"form-imagecheck-image\">
\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t</label>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
";
    ...
    {
        return "./routes/partials/admin/administrador.html";
    }
    ...
    {
        return new Source("", "./routes/partials/admin/administrador.html", "C:\\xampp\\htdocs\\PlantillaEscolar-ale\\public\\templates\\routes\\partials\\admin\\administrador.html");
    }
}
